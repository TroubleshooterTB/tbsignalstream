...
class PatternDetector:
    ...
    def detect_triangles_and_wedges(self, data: pd.DataFrame, lookback=30) -> Dict[str, Any]:
        ...
        high_slope, high_intercept, r_high, _, _ = np.polyfit(high_peaks, recent_data['High'].iloc[high_peaks], 1)
        low_slope, low_intercept, r_low, _, _ = np.polyfit(low_troughs, recent_data['Low'].iloc[low_troughs], 1)
